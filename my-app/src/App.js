...
const UserUpdate = React.lazy(() => import("./module/users/UserUpdate"));
const UserProfile = React.lazy(() => import("./module/users/UserProfile"));
const UserManage = React.lazy(() => import("./module/users/UserManage"));
const UserAddNew = React.lazy(() => import("./module/users/UserAddNew"));
